...
function Home(){
    // async axios.post("http://localhost:5173/home")
    const redirectToLogin = () => {
        window.open("http://localhost:5173/login", "_blank");  // Replace with your actual login URL
      };
    
      const redirectToSignup = () => {
        window.open("http://localhost:5173/signup", "_blank");  // Replace with your actual sign-up URL
      };
      ...
      const RedirectToCourses = () => {
        window.open("https://www.coursera.org/courses")
      }
      const RedirectToAlumniActivities = () => {
        window.open("http://localhost:5173/alumniactivities")
      }
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
          ...
          <div className="hidden grow items-start lg:flex justify-start">
            <ul className="ml-12 inline-flex space-x-8 justify-between">
              ...
              <li>
                <a href="http://localhost:5173/login" className="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900 mt-3">
                  Networking hub
                </a>
              </li>
  ...
  {/* Dropdown Menu */}
                <ul className="absolute hidden group-hover:block bg-white shadow-lg rounded-md mt-1">
    <li>
      <a
        href="#"
    ...
    <li>
      ...
      >
        Ideas
              ...
              {/* <li>
                <a href="http://localhost:5173/job" className="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900 mt-3">
                  Job Portal
                </a>
              </li> */}
              <li>
                <a href="http://localhost:5173/newsletter" className="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900 mt-3">
                  News Letter
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="http://localhost:5173/feedback" className="inline-flex items-center text-sm font-semibold text-gray-800 hover:text-gray-900 mt-3">
                  Feedback
                </a>
              </li>
              <li>
      ...
      <div className="pt-20 flex  mb-16">
        ...
        <div className="w-1/2 flex flex-col space-y-3 p-3 mr-10 mt-20">
          ...
          <button
            type="button"
            onClick={RedirectToAlumniActivities}
            className="inline-flex items-center rounded-md bg-orange-400 px-6 py-4 text-center font-semibold text-black hover:bg-orange-400"
          >
            Alumni Activities
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 h-4 w-4">
