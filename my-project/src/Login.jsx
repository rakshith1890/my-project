  ...
  async function submit(e) {
    ...
    try {
      ...
      if (res.data.status === "exist") {
        console.log("Login successful! Navigating to /network...");
        history("/network", {
          state: {
            id: res.data.user.id,
      ...
      console.error("Error in submit function:", e);
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 bg-white shadow-lg rounded-lg">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Email"
                    className="mt-2 flex h-10 w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-black placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1"
                  />
                </div>
            ...
            <div className="mt-3 space-y-3">
              <button className="relative inline-flex w-full items-center justify-center rounded-md border border-gray-400 bg-white px-3.5 py-2.5 font-semibold text-gray-700 hover:bg-gray-100 hover:text-black">
